...
!function(root, factory) {
    ...
    function makeSureSiblingsNamesAreUnique(prefix, name) {
        if (prefix in privateDataStorage) throw new SandboxError([ "Siblings can't have same names. ", name, " already exists." ].join(""));
    }
    ...
    }, SandboxListener.process = function(listener, candidateData, candidatePrefix) {
    ...
    }, rootName = "√", root = new Sandbox(rootName);
