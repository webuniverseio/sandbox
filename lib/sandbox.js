    ...
    function initSandBox(
        ...
        */
        var Sandbox = (function () {
	         ...
	         * permissions: Array, settings: {cache: boolean}, data: *}} PrivateData
	         */
            ...
            function Sandbox(name, data, settings) {
	            ...
	            if (parent) {
		            ...
		            if (_.some(parentKids, _.partial(hasSameName, name)) || parent.name === name) {
			            throw new SandboxError('same level sandboxes should have unique names');
		            }
            ...
            function kid() {
		        ...
		        var Factory = _.partial.apply(_, [Sandbox].concat(args));
		        return new Factory();
            }
	        ...
	        function callListenersWithCachedData(event, origin) {
		        ...
		        _.remove(thisData.cache, function (cachedEvent) {
	        ...
	        function on(event, handler) {
                ...
                if (thisData.settings.cache) {
	                callListenersWithCachedData.call(parent, event, name);
                }
            }
