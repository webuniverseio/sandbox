...
(function (root, factory) {
    ...
    function initSandBox(
        ...
        var Sandbox = (function () {
	         ...
	         * @return {PrivateData}
	         */
	        var getPrivateData = function getPrivateData(key) {
		        return privateDataStorage[key];
	        };
	        var getPrivateDataByRegex = function getPrivateDataByRegex(regex) {
	        ...
	        var on = function on(event, handler) {
		        ...
		        thisPrivateData.listeners.push(new ListenerStorage({
			        event: event,
			        handler: handler
		        }));
		    ...
		    function getTimingFnNameFromSettings(cacheSettings) {
            ...
            var emit = function emit(event, data) {
		        ...
		        candidates[parentPrefix] = getPrivateData(parentPrefix);
		        _.each(
			        _.extend( //TODO: no need to go over privateDataStorage twice
				        getPrivateDataByRegex(siblingPrefixRegExp),
				        getPrivateDataByRegex(kidsPrefixRegExp)
			        ),
			        function (privateData, prefix) {
		        ...
		        forValidPermissions(
			        candidates,
			        _.partial(permitIsValid, thisPrefix, event),
			        function onValidPermissions(privateData, prefix) {
				        ...
				        var timingFnName = getTimingFnNameFromSettings(cacheSettings);
				        var timingFn;
             ...
             * @this Sandbox
             */
            var grant = function grant(to, permissions) {
	         ...
	         * @this Sandbox
	         */
            var revoke = function revoke(from, permissions) {
		     ...
		     * @param {Number} index
		     */
		    InstanceData.prototype.addToStorage = function addToStorage(index) {
		    ...
		    PrivateData.prototype = {
			     ...
			     * @param {String} prefix
			     */
			    addToStorage: function addToStorage(prefix) {
	        ...
	        function Sandbox(name, data, settings) {
			    ...
			    var parentData = getInstanceData(parent);
				var fallbackName = _.uniqueId('empty');
				var childPrefix = _.uniqueId('/') + '/';
