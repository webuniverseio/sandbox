    ...
    function initSandBox(exports, _) {
        ...
        */
        var Sandbox = (function () {
            ...
            function data() {
                //jshint validthis: true
                return objectCreateLite(getPrivateData(this).data);
            }
            ...
            function on(event, handler) {
                ...
                if (thisData.settings.cache) {
	                ...
	                //TODO: see if that function could be moved out
                    _.each(_.where(thisData.cache, {name: event}), function (cachedEvent) {
                        var data = cachedEvent.data;
                        _.each(allListeners, function (listener) {
                            // TODO: check permissions based on listener origin and on thisData permissions and fire
                            // matching listeners
