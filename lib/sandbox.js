...
(function (root, factory) {
    ...
    function initSandBox(
	     ...
	     */
	    Sandbox.prototype.grant = function grantSandboxPermissions(to, permissions) {
		    ...
		    _.each(candidates.storage, function (candidateData, prefix) {
			    if (~_.indexOf(to, prefix)) {
				    simplePermissions.grant(candidateData.permissions, prefix, permissions);
			    }
		    });
	     ...
	     * @param {Object} permissions
	     */
	    Sandbox.prototype.revoke = function revokeSandboxPermissions(from, permissions) {
	    ...
	    Sandbox.prototype.destroy = function destroySandbox() {
		    ...
		    /*TODO: you can destroy children by using data.prefix, data.childrenPrefix to find appropriate InstanceData, PrivateData*/ //jshint ignore: line
	     ...
	     */
	    CachedEvent.prototype.updateExpiration = function updateEventExpiration(sandboxInfo, candidateData) {
	    ...
	    CachedEvent.prototype.whenUnhandledStoreIn = function whenUnhandledStoreEventIn(candidateData, sandboxInfo) {
		    var cachedEvent = this;
		    var cacheSettings = sandboxInfo.data.settings.cache;
		    //TODO: uh-oh, invokes only own listeners, not all candidate listeners :)
