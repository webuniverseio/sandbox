...
(function (root, factory) {
    ...
    function initSandBox(
	    ...
	    function Sandbox(name, data) {
		    ...
		    var prefix = createPrefix(parentData, name);
	    ...
	    Sandbox.prototype.settings = function setSandboxSettings(settings) {
		    ...
		    data.settings = _.merge(data.settings, settings);
	    };
	    /**
	    ...
	    Sandbox.prototype.on = function sandboxOn(eventName, handler, thisBinding) {
		    ...
		    //noinspection JSCheckFunctionSignatures
		    candidates
			    .add(PrivateData.getWrappedBy(info.parentPrefix))
			    .add(PrivateData.getByRegExp([info.siblingPrefixRegExp, info.chindrenPrefixRegExp]));
		    ...
		    forValidPermissions(
			    ...
			    //TODO: finished code reading here
	    ...
	    Sandbox.prototype.grant = function grantSandboxPermissions(to, permissionsMap) {
		    ...
		    //noinspection JSCheckFunctionSignatures
		    candidates
			    .add(PrivateData.getWrappedBy(info.prefix))
			    .add(PrivateData.getByRegExp(info.chindrenPrefixRegExp));
	    ...
	    /**
	     * @class InstanceData
	     * @param {{name: String, prefix: String, childrenPrefix: string, parentData: ?InstanceData, data: *}} params
	     */
	    ...
	    InstanceData.prototype.unMapFrom = function unAssignInstanceDataFrom(sandbox) {
	    ...
	    _.extend(
		    ...
		    /**@lends {PrivateData.prototype.constructor}*/{
			    ...
			    getWrappedBy: function getPrivateDatagetWrappedBy(prefix) {
				    return makeSimpleObject(prefix, PrivateData.get(prefix));
			    },
			    /**
	     ...
	     * @param {Object.<String, PrivateData>} data
	     */
	    CandidatesData.prototype.add = function addCandidatesData(data) {
		    _.extend(
			    this.storage,
			    data
		    );
