    ...
    function initSandBox(
        ...
        var Sandbox = (function () {
            ...
            function Sandbox(name, data, settings) {
		        ...
		        var parentData = getPrivateData(parent),
	                parentKids;
	            if (parent) {
		            parentKids = parentData.kids;
		            if (
			            _.some(parentKids, _.partial(hasSameName, name)) ||
			            parent.name === name || parentData.parent && parentData.parent.name === name
		            ) {
	        ...
	        function getKidListeners(kid) {
		        return getPrivateData(kid).listeners;
	        }
